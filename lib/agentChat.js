...
class AgentChat {
    ...
    sendLine(userSaid) {
        const apiaiSession = apiAiClient.textRequest(userSaid, {sessionId: 'remindmebot'});
        ...
        apiaiSession.on("response", (dfResponse) => {
            ...
            const options = {
                ...
                body: {
                    event: {
                        '@type': 'line',
                        'text': `<p dir='ltr' style='direction: ltr; text-align: left;'>You said: ${userSaid}<br><br>I'd say: ${speech}</p>`,
                        'textType': 'html'
                    }
                }
            };
